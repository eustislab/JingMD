...
plot(wavelength,epsilon,wavelength, gaussian1,wavelength, gaussian2,wavelength, gaussian3,wavelength, gaussian4)
...
print('-dpng', 'UVFromFitykWavelength')

plot(wavenumber,epsilon,wavenumber, gaussian1,wavenumber, gaussian2,wavenumber, gaussian3,wavenumber, gaussian4)
title('Absorption spectrum of aniline in water'), ylabel('molar absorptivity (M-1cm-1)'), xlabel('Wavenumber (cm-1)')
legend('Absorption spectrum','Underlying Gaussian 1','Underlying Gaussian 2','Underlying Gaussian 3','Underlying Gaussian 4')
print('-dpng', 'UVFromFitykWavenumber')